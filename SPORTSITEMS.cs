...
{
    public partial class SPORTSITEMS : Form
    {
        bool sidebarExpand;
        ...
        public SPORTSITEMS()
        {
            InitializeComponent(); this.Load += new EventHandler(SPORTSITEMS_Load); // Subscribe to the Load event
            FormClosing += SPORTSITEMS_LoadClosing;

        }
        private void SPORTSITEMS_LoadClosing(object sender, FormClosingEventArgs e)
        {
            Application.Exit();
        }

        private void SPORTSITEMS_Load(object sender, EventArgs e)
        {
        ...
        {
            string query = "SELECT Product_ID, Product_Name, Brand, Description, Price, Cost, Qty, Items_per_unit,Profit FROM Product WHERE Category_ID = 2";
        ...
        {
            Manage_Users manageForm = new Manage_Users();
            manageForm.Show();
            this.Hide();
        ...
        {
            CreditCustomers creditcustomerForm = new CreditCustomers();
            creditcustomerForm.Show();
            this.Hide();
        }
